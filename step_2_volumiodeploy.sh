...
git clone --depth 1 -b AxiomAirV1 --single-branch https://github.com/ColquhounAudio/Volumio2.git build/$BUILD/root/volumio
...
wget -O build/$BUILD/root/volumio/node_modules.tar.gz https://s3.amazonaws.com/axiom-air-install-files/AxiomAirV1/node_modules.tar.gz
