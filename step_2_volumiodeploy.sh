...
git clone --depth 1 -b BryFiV2 --single-branch https://github.com/ColquhounAudio/Volumio2.git build/$BUILD/root/volumio
echo 'Cloning Volumio UI'
git clone --depth 1 -b BryFiV2-dist --single-branch https://github.com/ColquhounAudio/Volumio2-UI.git "build/$BUILD/root/volumio/http/www"
...
wget -O build/$BUILD/root/volumio/node_modules.tar.gz https://s3.amazonaws.com/axiom-air-install-files/BryFiV2/node_modules.tar.gz
