...
cat /volumio/app/plugins/miscellanea/wizard/config.json.tmpl | sed -e "s/BryFi/$NEW_HOSTNAME/g" > /volumio/app/plugins/miscellanea/wizard/config.json
cat /volumio/app/plugins/system_controller/system/config.json.tmpl | sed -e "s/BryFi/$NEW_HOSTNAME/g" > /volumio/app/plugins/system_controller/system/config.json
cat /volumio/app/plugins/system_controller/network/config.json.tmpl | sed -e "s/BryFi/$NEW_HOSTNAME/g" > /volumio/app/plugins/system_controller/network/config.json
cat /volumio/app/plugins/system_controller/volumiodiscovery/config.json.tmpl | sed -e "s/BryFi/$NEW_HOSTNAME/g" > /volumio/app/plugins/volumiodiscovery/system/config.json
