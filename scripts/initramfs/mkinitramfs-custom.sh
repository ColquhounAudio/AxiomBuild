...
build_volumio_initramfs() {
  ...
  volbins+=('/sbin/parted' '/sbin/findfs' '/bin/lsblk' '/sbin/mke2fs' '/sbin/e2fsck' '/sbin/resize2fs' '/sbin/partprobe' '/sbin/mkfs.ext4' '/usr/bin/xdelta3' '/usr/bin/md5sum' '/usr/bin/sha1sum' '/usr/bin/sha256sum')
